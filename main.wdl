...
def helpMessage() {
  log.info """
    ...
    Optional arguments:
      ...
      --resmarker_info          Path to table of resmarker info. [Default: autgenerated by the pipeline]
    ...
    Examples:
      ...
      Set full genome
      nextflow run main.nf --readDIR path/to/read_dir --outDIR results --pools D1,R1,R2 --genome data/reference/v1/PkPfPmPoPv.fasta

      Set targeted reference
      nextflow run main.nf --readDIR path/to/read_dir --outDIR results --pools D1,R1,R2 --refseq_fasta resources/v4/v4_reference.fasta

      Alter Masking parameters
      nextflow run main.nf --readDIR path/to/read_dir --outDIR results --pools D1,R1,R2 --homopolymer_threshold 2 --trf_min_score 30 --trf_max_period 5
        """.stripIndent()
}
